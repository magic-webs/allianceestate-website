...
const cardClass =
  'rounded-[18px] border border-[rgba(220,210,190,0.5)] bg-white/96 px-8 py-7 shadow-[0_8px_30px_rgba(0,0,0,0.07)]';

const cardHeadingClass =
  'mb-5 flex items-center gap-[0.85rem] text-[0.68rem] font-bold tracking-[2.5px] text-primary';

const inputClass =
  'w-full rounded-[10px] border border-cream-border bg-cream-field py-[0.8rem] pr-[0.9rem] pl-10 font-body text-[0.9rem] text-ink outline-none transition-[border-color,box-shadow] duration-300 placeholder:text-[#c0b8ad] focus:border-gold focus:bg-white focus:shadow-[0_0_0_3px_rgba(201,162,39,0.1)]';

const iconClass = 'pointer-events-none absolute left-[0.9rem] z-1 flex items-center text-[#bbb]';
...
const ContactSection = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-cream" id="contact">
      ...
      <div className="relative h-[300px] w-full md:h-[380px]">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(249,246,240,0.92)_0%,rgba(249,246,240,0.6)_45%,rgba(249,246,240,0)_100%)]" />

        {/* Absolute-positioned header over image */}
        <div className="absolute top-0 left-0 mx-auto flex h-full w-full max-w-page items-start justify-between px-6 pt-6 md:px-8 md:pt-8 xl:px-16 xl:pt-10">
          {/* Left: text */}
          <div className="max-w-[480px]">
            ...
            <h2 className="mb-[0.85rem] font-serif text-[2.5rem] leading-[1.1] font-bold text-primary md:text-[3.4rem]">
              Let&apos;s Build <span className="font-semibold text-gold italic">What&apos;s Next.</span>
            </h2>
            <p className="max-w-[420px] text-[0.97rem] leading-[1.65] text-[#555]">
          ...
          <div className="pointer-events-none absolute top-8 left-1/2 hidden -translate-x-1/2 text-center font-script text-[1.9rem] leading-[1.35] text-black/70 italic md:block">
            Better
            <br />
            <em>Spaces</em>
            <br />
          ...
          <div className="hidden flex-col items-end gap-1 pt-2 md:flex [&>span]:text-[0.65rem] [&>span]:font-bold [&>span]:tracking-[2.5px] [&>span]:text-[rgba(50,40,20,0.65)]">
            <span>PEOPLE</span>
            <span>PLACES</span>
      ...
      <div className="relative z-5 mx-auto -mt-5 grid w-full max-w-page grid-cols-1 items-start gap-6 px-6 pb-10 md:-mt-10 md:px-8 md:pb-12 lg:-mt-20 lg:grid-cols-[1.15fr_1fr] xl:px-16 xl:pb-16">
        {/* Form Card */}
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-[0.85rem]">
            ...
            <div className="grid grid-cols-1 gap-[0.85rem] md:grid-cols-2">
              ...
              <div className="relative flex items-center">
                ...
                <select name="interest" value={formData.interest} onChange={handleChange} className={`${inputClass} cursor-pointer appearance-none`}>
                ...
                <span className="pointer-events-none absolute right-[0.9rem] text-[#bbb]">
            ...
            <div className="mt-1 flex flex-col items-start gap-5 md:flex-row md:items-center">
              ...
              <span className="text-[0.82rem] text-[#999]">We&apos;ll get back to you within 24 hours.</span>
            </div>

            <div className="mt-1 flex items-center gap-2 text-[0.75rem] text-[#aaa]">
        ...
        <div className={cardClass}>
          <div className="mb-5 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
              ...
              <div className="flex flex-col gap-[0.85rem] [&>div>svg]:mt-0.5 [&>div>svg]:shrink-0">
                <div className="flex items-start gap-2.5 text-[0.87rem] leading-[1.5] text-ink">
            ...
            <div>
              ...
              <div className="mb-4 flex gap-2.5 [&>a]:flex [&>a]:h-[38px] [&>a]:w-[38px] [&>a]:items-center [&>a]:justify-center [&>a]:rounded-[9px] [&>a]:border [&>a]:border-cream-border [&>a]:bg-cream-field [&>a]:text-primary [&>a]:transition-all [&>a]:duration-300 [&>a:hover]:-translate-y-0.5 [&>a:hover]:border-gold [&>a:hover]:text-gold [&>a:hover]:shadow-[0_4px_10px_rgba(201,162,39,0.2)]">
              ...
              <div className="flex flex-col gap-[0.3rem] [&>span]:text-[0.65rem] [&>span]:font-bold [&>span]:tracking-[2px] [&>span]:text-muted">
                <span>PEOPLE</span>
                <span>PLACES</span>
                <span>POSSIBILITIES</span>
              </div>
          ...
          {/* Map */}
          <div className="relative h-[175px] overflow-hidden rounded-xl border border-cream-border">
            <iframe
            ...
            <a
              ...
              className="absolute right-[0.6rem] bottom-[0.6rem] flex items-center gap-[0.3rem] rounded-[7px] border border-cream-border bg-white/97 px-[0.7rem] py-[0.35rem] text-[0.75rem] font-semibold text-primary no-underline shadow-[0_2px_8px_rgba(0,0,0,0.08)] transition-all duration-300 hover:bg-primary hover:text-white"
            >
              View on Google Maps ↗
            </a>
          </div>
