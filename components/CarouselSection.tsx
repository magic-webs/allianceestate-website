...
const CarouselSection = () => {
  ...
  return (
    <section className="overflow-hidden bg-[#fafbfc] py-12" id="carousel" onWheel={handleWheel}>
        ...
        <div className="relative mx-[30px] grid min-h-[500px] w-[calc(100%-60px)] max-w-page gap-6 overflow-hidden rounded-[20px] bg-white p-6 shadow-[0_20px_40px_rgba(0,0,0,0.05)] md:rounded-[30px] md:p-8 lg:grid-cols-[35%_65%] lg:p-10">
          <div className="z-10 mb-8 flex flex-col justify-center lg:mb-0 lg:pr-6">
            <div>
              ...
              <button className="inline-block w-max rounded-[40px] bg-[linear-gradient(to_right,var(--color-gold-dark),var(--color-gold))] px-7 py-2.5 text-sm font-medium text-white shadow-[0_8px_16px_rgba(201,162,39,0.3)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_20px_rgba(201,162,39,0.4)]">
                Explore &rarr;
              </button>
            </div>
