...
const residentialSectors = [
  {
    ...
    slug: '/projects/residential/noida-sector-18',
    image: '/Residential-plot.jpeg',
    badge: 'Commercial & High Demand',
    desc: 'Prime commercial hub with world-class retail infrastructure, metro connectivity, and rapid land value appreciation.',
    plotSizes: '100 - 500 Sq. Yds.',
    highlights: ['Metro Connectivity', 'High Footfall Hub', 'Immediate Possession'],
  },
  {
    name: 'Noida Sector 20',
    slug: '/projects/residential/noida-sector-20',
    image: '/Residential-plot.jpeg',
    badge: 'Established Residential',
    desc: 'Ultra-luxurious residential sector with wide green belts, top-tier schools, and excellent proximity to DND Flyway.',
    plotSizes: '150 - 1000 Sq. Yds.',
    highlights: ['Lush Green Parks', '24/7 Security Enclosure', 'Ready Construction'],
  },
  {
    name: 'Noida Sector 21',
    slug: '/projects/residential/noida-sector-21',
    image: '/Residential-plot.jpeg',
    badge: 'Premium Sector',
    desc: 'Exclusive residential pocket featuring wide roads, institutional proximity, and high end-user demand.',
